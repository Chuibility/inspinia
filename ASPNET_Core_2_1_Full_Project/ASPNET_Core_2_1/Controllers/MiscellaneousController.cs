...
namespace ASPNET_Core_2_1.Controllers
{
    public class MiscellaneousController : Controller
    {
        ...
        public IActionResult Timeline_second_version()
        {
            return View();
        }

        public IActionResult Forum_view()
        {
            return View();
        }

        public IActionResult Forum_post_view()
        {
            return View();
        }

        public IActionResult Tree_view()
        {
            return View();
        }

        public IActionResult Chat_view()
        {
            return View();
        }

        public IActionResult AgileBoard()
        {
            return View();
        }
        ...
        public IActionResult PasswordMeter()
        {
            return View();
        }
        ...
        public IActionResult TextSpinners()
        {
            return View();
        }
        ...
        public IActionResult SocialButtons()
        {
            return View();
        }
    }
